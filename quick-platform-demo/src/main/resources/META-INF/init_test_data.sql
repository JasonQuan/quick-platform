...
INSERT INTO  STUDENTS (ID, AGE, CLASSS, CREATED_BY, CREATED_TIME, NAME, SEX, VERSION) 	VALUES ('1', 12, 1, NULL, CURRENT_TIMESTAMP, 'Tina', 'girl', NULL);
INSERT INTO  STUDENTS (ID, AGE, CLASSS, CREATED_BY, CREATED_TIME, NAME, SEX, VERSION) 	VALUES ('2', 14, 2, NULL, CURRENT_TIMESTAMP, 'Mike', 'boy', NULL);
